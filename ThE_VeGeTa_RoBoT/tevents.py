...
from ThE_VeGeTa_RoBoT import MONGO_DB_URI
from ThE_VeGeTa_RoBoT import telethn

client = MongoClient()
client = MongoClient(MONGO_DB_URI)
db = client["ThE_VeGeTa_RoBoT"]
gbanned = db.gban
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ThE_VeGeTa_RoBoT.tevents

        path = Path(f"ThE_VeGeTa_RoBoT/modules/{shortname}.py")
        name = "ThE_VeGeTa_RoBoT.modules.{}".format(shortname)
...
path = "ThE_VeGeTa_RoBoT/modules/*.py"
