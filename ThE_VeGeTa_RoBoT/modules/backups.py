...
import ThE_VeGeTa_RoBoT.modules.sql.notes_sql as sql
from ThE_VeGeTa_RoBoT import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ThE_VeGeTa_RoBoT.__main__ import DATA_IMPORT
from ThE_VeGeTa_RoBoT.modules.helper_funcs.chat_status import user_admin
from ThE_VeGeTa_RoBoT.modules.helper_funcs.alternate import typing_action

# from ThE_VeGeTa_RoBoT.modules.rules import get_rules
import ThE_VeGeTa_RoBoT.modules.sql.rules_sql as rulessql

# from ThE_VeGeTa_RoBoT.modules.sql import warns_sql as warnssql
import ThE_VeGeTa_RoBoT.modules.sql.blacklist_sql as blacklistsql
from ThE_VeGeTa_RoBoT.modules.sql import disable_sql as disabledsql

# from ThE_VeGeTa_RoBoT.modules.sql import cust_filters_sql as filtersql
# import ThE_VeGeTa_RoBoT.modules.sql.welcome_sql as welcsql
import ThE_VeGeTa_RoBoT.modules.sql.locks_sql as locksql
from ThE_VeGeTa_RoBoT.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("vegeta{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("vegeta{}.backup".format(chat_id), "rb"),
    ...
    os.remove("vegeta{}.backup".format(chat_id))  # Cleaning file
