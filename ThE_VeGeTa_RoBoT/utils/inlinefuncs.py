...
from ThE_VeGeTa_RoBoT.extrastuff import SUDOERS
from ThE_VeGeTa_RoBoT import LOG_GROUP_ID
from ThE_VeGeTa_RoBoT import pgram as app 
from ThE_VeGeTa_RoBoT.arqclient import arq
from ThE_VeGeTa_RoBoT.utils.keyboard import ikb
from ThE_VeGeTa_RoBoT.core.tasks import _get_tasks_text, all_tasks, rm_task
from ThE_VeGeTa_RoBoT.core.types import InlineQueryResultCachedDocument
from ThE_VeGeTa_RoBoT.modules.info import get_chat_info, get_user_info
from ThE_VeGeTa_RoBoT.modules.media import download_youtube_audio
from ThE_VeGeTa_RoBoT.utils.functions import test_speedtest
from ThE_VeGeTa_RoBoT.utils.pastebin import paste
...
async def inline_help_func(__help__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/NiGhTBoT22/ThE_VeGeTa_RoBoT"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[VeGeTa✨](https://github.com/NiGhTBoT22/ThE_VeGeTa_RoBoT):**
**RoBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check VeGeTa's Stats",
