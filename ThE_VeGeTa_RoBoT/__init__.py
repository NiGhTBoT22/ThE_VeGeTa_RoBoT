...
if ENV:
    ...
    from ThE_VeGeTa_RoBoT.config import Development as Config
    TOKEN = Config.TOKEN
...
pgram = Client("vegepyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
mongo_client = MongoClient(MONGO_DB_URI)
db = mongo_client.ThE_VeGeTa_RoBoT
...
from ThE_VeGeTa_RoBoT.modules.helper_funcs.handlers import (CustomCommandHandler,
...
INFO GATHERED!
Client: vegeta pyro 
Copyright: (c) 2021 ThE_VeGeTa_RoBoT
"""
print(end_credits)
